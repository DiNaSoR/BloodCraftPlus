...
internal class Plugin : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        {
            LogInstance.LogInfo("BloodCraftPlus is a server mod and will not continue loading on the client; this is not an error, and likely just means you're using ServerLaunchFix in which case you may disregard this");
