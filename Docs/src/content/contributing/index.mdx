...
Guidelines for contributing to BloodCraft.

## Overview

BloodCraft is a monorepo containing:
- **Server mod** — `Server/BloodCraft/`
- **Client mod** — `Client/BloodUI/`
...
```bash
git clone https://github.com/DiNaSoR/BloodCraft.git
cd BloodCraft
```
...
```bash
# Client mod
dotnet build Client/BloodUI/BloodUI.csproj -c Release

# Server mod
dotnet build Server/BloodCraft/BloodCraft.csproj -c Release
...
- [GitHub Repository](https://github.com/DiNaSoR/BloodCraft)
