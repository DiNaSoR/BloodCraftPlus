...
- Works with the Gear Level Mirage system
...
BloodCraftPlus implements a "Gear Level Mirage" system:

```
Display Level = Player Level + Weapon Expertise
```

- Your displayed gear level combines your actual level with weapon mastery
- Armor level is hidden (set to 0) to emphasize weapon expertise
- Creates an immersive "power fantasy" where weapon skill matters
